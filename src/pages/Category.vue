<template>
	<div class="category">
		...
		<div class="table" v-loading='loading'>
	      ...
	      <el-table-column prop="name" label="动物名称" width="180"></el-table-column>
	      <el-table-column prop="parent.name" label="动物类别" width="180"></el-table-column>
	      <el-table-column prop="comment" label="介绍"></el-table-column>
		...
		<el-dialog :title="categoryDialog.title" :visible.sync="categoryDialog.visible">
		  ...
		  <el-form ref="categoryForm" :rules='rules' :model="categoryDialog.form" label-position='left' size='small'>
		    <el-form-item label="动物名称" label-width="100px" prop="name">
		      <el-input v-model="categoryDialog.form.name" autocomplete="off"></el-input>
		    </el-form-item>
		    <el-form-item label="动物类别" label-width="100px">
		      <el-select style='width:100%' v-model="categoryDialog.form.parentId" placeholder="一级栏目">
				...
				<el-form-item label="动物介绍" label-width="100px">
		      <el-input
					  type="textarea"
					  :rows="2"
					  placeholder="请输入内容"
